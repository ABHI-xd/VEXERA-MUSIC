...
from vexera.play import cb_admin_check
from Abhixd.channelmusic import get_chat_id
from Abhixd.dbtools import delcmd_is_on, delcmd_off, delcmd_on
...
@Client.on_message(command(["reload", "vexera", f"reload@{BOT_USERNAME}"]))
